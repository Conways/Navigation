...
-keep public class * extends android.app.Activity      # 保持Activity不被混淆
-keep public class * extends android.app.Application   # 保持Application不被混淆
-keep public class * extends android.app.Service       # 保持Service不被混淆
-keep public class * extends android.content.BroadcastReceiver  # 保持BroadcastReceiver不被混淆
